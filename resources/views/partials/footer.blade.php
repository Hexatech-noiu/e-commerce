<footer class="bg-primary-40">
  <div id="FAQModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <div class="pt-10 px-12 mt-10 lg:mt-20">
        <div class="flex flex-col lg:flex-row gap-16 mx-auto max-w-screen-xl xl:gap-16">
            <div class="lg:w-[35%]">
                ...
                <p class="max-w-2xl mb-5 font-light text-white text-lg">E-Commerce SMK Negeri 2 Sumedang adalah sebuah platform penjualan online yang dikelola oleh siswa dan siswi SMK Negeri 2 Sumedang.</p>
                <div class="flex flex-row gap-4">
                    <a href="https://wa.me/6287894818815/" target="blank" class="flex justify-center items-center w-10 h-10 rounded-full text-white hover:text-primary-40 bg-primary-40 hover:bg-white hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <i class="fa-brands fa-whatsapp fa-xl text-center"></i>
                    </a>
                    <a href="https://www.instagram.com/smkn2sumedang.official" target="blank" class="flex justify-center items-center w-10 h-10 text-xl rounded-full text-white hover:text-primary-40 bg-primary-40 hover:bg-white hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <i class="fa-brands fa-instagram fa-lg text-center"></i>
                    </a>
                    <a href="https://www.facebook.com/officialsmkn2sumedang.sch.id" target="blank" class="flex justify-center items-center w-10 h-10 rounded-full text-white hover:text-primary-40 bg-primary-40 hover:bg-white hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
                        <i class="fa-brands fa-facebook-f fa-lg text-center"></i>
                    </a>
                    <a href="https://www.youtube.com/@smkn2sumedang703" target="blank" class="flex justify-center items-center w-10 h-10 rounded-full text-white hover:text-primary-40 bg-primary-40 hover:bg-white hover:scale-125 hover:rotate-[720deg] transition-all duration-[400ms]">
    ...
    <div class="flex items-center justify-center py-6 mt-7 border-t border-white">
        <span class="text-xs sm:text-base font-light text-white text-center">© {{date('Y')}} <a href="#">SMKN 2 Sumedang™</a>. All Rights Reserved</span>
    </div>
</footer>
