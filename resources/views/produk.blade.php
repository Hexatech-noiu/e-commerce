        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-4">
          <div class="rounded-sm group relative h-72 items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
            <div class="h-full w-72">
              <img class="h-full w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="{{ asset('img/noiu.jpg') }}" alt="" />
            </div>
            ...
            <div class="absolute inset-0 flex translate-y-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
              <h1 class="font-dmserif text-3xl font-bold text-white">Kaos Pendek</h1>
              <p class="mb-3 text-lg text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">Rp. 50.000</p>
              <button class="rounded-sm bg-primary-40 py-2 px-3.5 text-sm capitalize text-white hover:text-black hover:bg-secondary-40 duration-[400ms] shadow shadow-black/60">Beli Produk</button>
            </div>
          </div>
        </div>
      </div>
