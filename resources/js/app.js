...
window.copyProp = function(prod_id, mode) {
    ...
    switch (mode){
        case "read":
            ...
            document.getElementById('pre-category').innerHTML = data.categoryName
        ...
        case "update":
            ...
            document.getElementById('update_form').action = "/dashboard/produk/" + prod_id
        case "delete":
            document.getElementById('delete_name').innerText = data.name
            document.getElementById('delete_form').action = "/dashboard/produk/" + prod_id
    }
}
