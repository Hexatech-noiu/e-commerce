    ...
    try {
        await fetch(url, {
            ...
            .catch(
                (e) =>
                    (itu.innerHTML =
                        "<div class='flex justify-center items-center text-center font-bold text-2xl'>Something went wrong in our server, we're so sorry</div>")
            );
    } catch (e) {
        console.error(e);
    }
...
window.onload = getData(0, "#panel-1");
